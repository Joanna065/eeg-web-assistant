...
from eeg_web_assistant.ml.models.cbam import build_cbam_model
...
with settings.ModelHParams.CBAM_HPARAMS.open(mode='r') as f:
    hparams = json.load(f)
...
# get model
train_model(model_fun=build_cbam_model, model_params=model_params, train_params=train_params,
